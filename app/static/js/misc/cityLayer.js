...
// 				cityInfo.population /= 1000000;
// 				cityInfo.daily_consumption /= 1000;
...
// 				let city = new City(cityInfo.name, cityInfo.population, cityInfo.daily_consumption, cityTile);
