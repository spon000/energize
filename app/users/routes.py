...
def login():
  ...
  if form.validate_on_submit():
    ...
    if user and bcrypt.check_password_hash(user.password, form.password.data):
      ...
      flash(f'Login unsuccessful. Please check credentials and try again.', 'danger')
...
def account():
  ...
  return render_template("account.html", title="Account Information", image_file=image_file, form=form)
